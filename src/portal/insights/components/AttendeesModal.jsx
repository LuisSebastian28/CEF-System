                ...
                {(isAdding || isEditing) && (
                    <div className="fixed inset-0 bg-gray-900 bg-opacity-80 flex justify-center items-center z-60 p-6">
                        <div className="bg-white p-10 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-y-auto relative">
                            ...
                            <form onSubmit={handleFormSubmit} className="space-y-6 grid grid-cols-2 gap-4">
                                ...
                                {personalInfoFields.map((field) => (
                                    <div key={field} className="flex flex-col mb-4">
                                        ...
                                        {field === 'child_tshirt_size' ? (
                                            ...
                                            <input
                                                type={typeof config.initialValues[field] === 'boolean' ? 'checkbox' : 'text'}
                                                name={field}
                                                checked={typeof config.initialValues[field] === 'boolean' ? formValues[field] : undefined}
                                                value={formValues[field] || ''}
                                                onChange={handleInputChange}
                                                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none"
                                            />
                                ...
                                <div className="flex justify-end gap-6 mt-8 col-span-2">
